...
After connecting, the sidebar lists all databases on the server. Expand a database to see its tables, views, and materialized views. Press **Cmd+K** or click the database name in the toolbar to switch.
