...
Or manually: Download from [GitHub Releases](https://github.com/datlechin/tablepro/releases):
...
Need help? Check [Installation](/installation) or [open an issue](https://github.com/datlechin/tablepro/issues) on GitHub.
