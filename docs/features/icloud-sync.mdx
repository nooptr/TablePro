...
Each data type has its own toggle: Connections, Groups & Tags, App Settings, and Query History (with a configurable limit: 100, 500, 1,000, or unlimited). Enable **Passwords** to sync credentials via iCloud Keychain (end-to-end encrypted). Off by default.
