...
The row number column (`#`) shows sequential numbers for each row. You can hide it if you prefer a cleaner view:

- **On**: Row numbers visible as the first column (default)
- **Off**: Row number column hidden

Configure in **Settings** > **Data Grid** > **Show Row Numbers**.
